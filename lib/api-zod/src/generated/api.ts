...
export const ListHotelsResponse = zod.object({
  ...
  "earlyCheckInEnabled": zod.boolean().nullish(),
  "earlyCheckInTime": zod.string().nullish(),
  "earlyCheckInPrice": zod.number().nullish(),
...
export const CreateHotelBody = zod.object({
  ...
  "earlyCheckInEnabled": zod.boolean().optional(),
  "earlyCheckInTime": zod.string().optional(),
...
export const ListBookingsResponse = zod.object({
  ...
  "earlyCheckIn": zod.boolean().optional(),
  "earlyCheckInAmount": zod.number().optional(),
