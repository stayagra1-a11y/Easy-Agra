...
import { IndianRupee, TrendingUp, Clock, CheckCircle, Wallet, Download, Plus, Utensils } from "lucide-react";
...
export default function RestaurantOwnerEarnings() {
  ...
  const handleExport = () => {
    ...
    a.href = url; a.download = "restaurant-earnings.csv"; a.click();
  };
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-foreground flex items-center gap-2">
              <Utensils className="w-7 h-7 text-primary" /> My Earnings
            </h1>
            <p className="text-muted-foreground text-sm mt-1">Restaurant reservation revenue and payouts</p>
          </div>
