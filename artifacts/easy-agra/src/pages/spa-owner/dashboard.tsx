...
import { Sparkles, Star, Users, TrendingUp, Bell, CheckCircle2 } from "lucide-react";
    ...
    <OwnerLayout>
      <div className="space-y-5">
        <div className="bg-gradient-to-r from-primary to-primary/80 text-white rounded-2xl p-5">
          ...
          <p className="text-white/70 text-sm mt-1">Manage your spa on Easy Agra</p>
        </div>
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-600 mt-0.5">Spa listing features coming soon</p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            { label: "Appointments", value: "—", icon: Users, color: "text-green-600 bg-green-50" },
        ...
        <Card className="border-dashed border-2 border-primary/20">
          <CardContent className="p-5 text-center">
            ...
            <p className="font-semibold text-muted-foreground">Spa Management</p>
            <p className="text-sm text-muted-foreground/70 mt-1">Service catalogue, appointment scheduling, and reviews are coming soon!</p>
