...
export default function SpaOwnerReviews() {
  ...
  const replyMut = useMutation({
    mutationFn: ({ id, body }: { id: number; body: any }) => apiRequest(`/api/spa-reviews/${id}/reply`, { method: "POST", body }),
    onSuccess: () => {
      toast({ title: "Reply posted!" });
      setReplyDialog(null);
      queryClient.invalidateQueries({ queryKey: ["spa-reviews", "owner"] });
    },
    ...
    <OwnerLayout>
      <div className="p-4 max-w-lg mx-auto space-y-4 pb-28">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage and reply to your spa reviews</p>
        </div>
